...
\begin{definition}[General Position]
  ...
  \lean{FormalButterfly.GeneralPosition}
...
\begin{definition}[Collinear Determinant]
  ...
  \lean{FormalButterfly.collinearDet}
...
\begin{lemma}[Collinear iff Determinant Zero]
  ...
  \lean{FormalButterfly.collinear_iff_det_zero}
...
\begin{remark}[Zulip Discussion and Future Generalizations]
...
\begin{definition}[Cocyclic Determinant]
  ...
  \lean{FormalButterfly.cocyclicDet}
...
\begin{lemma}[Concyclic iff Determinant Zero]
  ...
  \lean{FormalButterfly.cocyclic_iff_det_zero}
